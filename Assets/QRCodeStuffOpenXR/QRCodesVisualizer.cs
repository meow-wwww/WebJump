...
namespace QRTracking
{
    public class QRCodesVisualizer : MonoBehaviour
    {
        ...
        //SetWebViewPosition webViewManager;
        ...
        void Start()
        {
            ...
            //webViewManager = GameObject.Find("WebViewManager").GetComponent<SetWebViewPosition>();
        }
            ...
            lock (pendingActions)
            {
                while (pendingActions.Count > 0)
                {
                    ...
                    if (action.type == ActionData.Type.Added)
                    {
                        ...
                        // send qr position to webview
                        //webViewManager.setAnchorPositon(qrCodeObject.transform.position);
